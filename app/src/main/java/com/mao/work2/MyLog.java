...
public class MyLog
{
	...
	public static void d(String info){
		...
		try {
			File dir = Environment.getExternalStoragePublicDirectory("AppProjects");

			if(!dir.exists()){   
				dir.mkdir();  
			}

			File file = new File(Environment.getExternalStoragePublicDirectory("AppProjects"),"log.txt");
